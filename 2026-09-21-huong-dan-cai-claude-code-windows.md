# Cài Claude Code (claude-cli) trên Windows — hướng dẫn từng bước cho người mới
...
Muốn làm gọn trong một lần: mở **PowerShell 64-bit** (Bước 1), rồi mở tệp `2026-09-21-script-cai-claude-code-windows.ps1` trong cùng thư mục này, sao chép **toàn bộ nội dung**, dán vào PowerShell và nhấn Enter.
...
## Phụ lục — nếu máy dùng macOS, Linux hoặc WSL

Phần trên viết cho **Windows**. Phụ lục này để tham khảo khi cần cài trên máy khác: nếu máy là macOS (13.0 trở lên), Linux (Ubuntu 20.04+, Debian 10+) hoặc WSL, thay Bước 1–4 bằng một lệnh trong Terminal:
